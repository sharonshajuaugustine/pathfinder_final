...
// 15-question item bank: 3 numerical, 3 logical, 2 verbal, 2 spatial, 2 scientific,
// 3 personality/work-preference. Personality questions carry no correct answer —
// each choice maps to behavioral trait/interest signals instead.
//
// Answer key lives here on the server only; the GET endpoint strips signals before
...
export const ASSESSMENT_ITEMS: AssessmentItem[] = [
...

  {
    id: "num_01",
    dimension: "numerical",
    questionText: "A shopkeeper buys an item for ₹80 and sells it for ₹100. What is the profit percentage?",
    choices: [
...

  {
    id: "num_02",
    dimension: "numerical",
    questionText: "6 workers can complete a task in 10 days. How many days will 10 workers take to complete the same task?",
    choices: [
...

  {
    id: "log_03",
    dimension: "logical",
    questionText: "All doctors are engineers. Some engineers are scientists. Which statement is DEFINITELY true?",
    choices: [
...

  {
    id: "ver_02",
    dimension: "verbal",
    questionText: "Choose the word OPPOSITE in meaning to 'Turbulent':",
    choices: [
      { id: "a", text: "Stormy", signals: [{ score: 0 }] },
      { id: "b", text: "Calm",   signals: [{ score: 100 }] },
      { id: "c", text: "Active", signals: [{ score: 0 }] },
      { id: "d", text: "Loud",   signals: [{ score: 0 }] },
    ],
  },
...

  {
    id: "spa_01",
    dimension: "spatial",
    questionText: "A square sheet of paper is folded in half, then folded in half again. A hole is punched through all layers. How many holes appear when the paper is fully unfolded?",
    choices: [
...

  {
    ...
    choices: [
      { id: "a", text: "8",  signals: [{ score: 0 }] },
      { id: "b", text: "10", signals: [{ score: 0 }] },
      { id: "c", text: "12", signals: [{ score: 100 }] },
      { id: "d", text: "16", signals: [{ score: 0 }] },
    ],
  },
  ...
  // ─────────────────── PERSONALITY / WORK PREFERENCE (3) ───────────────────
  // No correct answer. Each choice maps to personality traits, RIASEC, and
  // interest clusters. All values are positive — absence signals nothing.

  {
    ...
    choices: [
      {
        id: "a",
        text: "Solving a math puzzle or logic game",
        signals: [
