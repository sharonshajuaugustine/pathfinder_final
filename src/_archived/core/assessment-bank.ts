...
export const ASSESSMENT_ITEMS: AssessmentItem[] = [
...

  {
    id: "apt_numerical",
    dimension: "numerical",
    questionText: "If a train travels at a constant speed of 60 km/h, how many kilometers will it travel in 2.5 hours?",
    choices: [
      { id: "a", text: "150 km", signals: [{ score: 100 }] },
      { id: "b", text: "120 km", signals: [{ score: 0 }] },
      { id: "c", text: "180 km", signals: [{ score: 0 }] },
      { id: "d", text: "130 km", signals: [{ score: 0 }] },
    ],
  },

  {
    id: "apt_logical",
    dimension: "logical",
    questionText: "If box A is heavier than box B, and box B is heavier than box C, which statement must be true?",
    choices: [
      { id: "a", text: "Box A is heavier than box C", signals: [{ score: 100 }] },
      { id: "b", text: "Box C is heavier than box A", signals: [{ score: 0 }] },
      { id: "c", text: "Box B is the heaviest box", signals: [{ score: 0 }] },
      { id: "d", text: "Box A and box C weigh the same", signals: [{ score: 0 }] },
    ],
  },

  {
    id: "apt_verbal",
    dimension: "verbal",
    questionText: "Pick the word that is the opposite of 'ANCIENT'.",
    choices: [
      { id: "a", text: "Modern", signals: [{ score: 100 }] },
      { id: "b", text: "Old", signals: [{ score: 0 }] },
      { id: "c", text: "Historic", signals: [{ score: 0 }] },
      { id: "d", text: "Antique", signals: [{ score: 0 }] },
    ],
  },

  {
    id: "apt_spatial",
    dimension: "spatial",
    questionText: "At exactly 3:00, what is the angle formed between the hour hand and the minute hand of an analog clock?",
    choices: [
      { id: "a", text: "90 degrees", signals: [{ score: 100 }] },
      { id: "b", text: "180 degrees", signals: [{ score: 0 }] },
      { id: "c", text: "45 degrees", signals: [{ score: 0 }] },
      { id: "d", text: "120 degrees", signals: [{ score: 0 }] },
    ],
  },

  {
    ...
    questionText: "Which gas do plants release during photosynthesis that humans need to breathe?",
    choices: [
      { id: "a", text: "Oxygen", signals: [{ score: 100 }] },
      { id: "b", text: "Carbon dioxide", signals: [{ score: 0 }] },
      { id: "c", text: "Nitrogen", signals: [{ score: 0 }] },
      { id: "d", text: "Hydrogen", signals: [{ score: 0 }] },
    ],
  },
